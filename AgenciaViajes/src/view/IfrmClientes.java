...
public class IfrmClientes extends JInternalFrame {
	/**
	 * 
	 */
...
//				datos.addRow(filaData);
				tbclientes.actualizarTabla(txtFiltro.getText());
			}
		});
		panel.add(button);
		...
		btnNewButton.setIcon(new ImageIcon(IfrmClientes.class.getResource("/icons/filter16.png")));
		panel.add(btnNewButton);
		
		JScrollPane scrollPane = new JScrollPane();
		getContentPane().add(scrollPane, BorderLayout.CENTER);
		
		tbclientes = new TbClientes(txtFiltro.getText());
